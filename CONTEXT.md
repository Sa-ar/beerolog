...
| `Beer history` | The beers a signed-in user has rated over time. Stored from day one. Wiring into `BaselineTaste` embedding updates is a separate, post-validation concern — see [[rating-feedback-loop-deferred]]. |
