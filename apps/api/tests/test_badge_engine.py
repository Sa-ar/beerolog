...
LAGER = FlavorVector(bitterness=0.15, sweetness=0.1, fruitiness=0.1, roast=0.0, sourness=0.0, body=0.2, adventure=0.15)
STOUT = FlavorVector(bitterness=0.45, sweetness=0.35, fruitiness=0.1, roast=0.95, sourness=0.0, body=0.9, adventure=0.3)
...
def test_taste_evolution_no_badge_when_drift_small():
    ...
    slight = FlavorVector(bitterness=0.17, sweetness=0.12, fruitiness=0.1,
                          roast=0.0, sourness=0.0, body=0.22, adventure=0.15)
