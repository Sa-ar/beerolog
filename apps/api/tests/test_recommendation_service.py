...
from app.services.recommendation_service import aggregate_group_vectors, score_beers
...
def _beer(id: str, **dims) -> dict:
    ...
    return {
        ...
        "brewery": "test",
        "style": "lager",
        "flavor_vector": fv.to_list(),
    }


LAGER = _beer(
    "lager", bitterness=0.1, sweetness=0.2, fruitiness=0.1, roast=0.0, sourness=0.0, body=0.2
)
IPA = _beer("ipa", bitterness=0.9, fruitiness=0.7, roast=0.1, sweetness=0.1, sourness=0.1, body=0.5)
STOUT = _beer(
    "stout", roast=0.9, body=0.9, bitterness=0.5, sweetness=0.3, fruitiness=0.1, sourness=0.0
)
SOUR = _beer(
    "sour", sourness=0.9, fruitiness=0.7, bitterness=0.1, sweetness=0.2, roast=0.0, body=0.3
)
