...
export function NotFoundIllustration() {
  return (
    <svg viewBox="0 0 200 160" className="h-36 w-44" aria-hidden role="img">
      <ellipse cx="100" cy="148" rx="56" ry="8" fill="hsl(44 88% 90%)" />
      <g transform="rotate(6 100 96)">
        ...
        <path
          ...
          opacity="0.5"
        />
        <ellipse cx="100" cy="76" rx="24" ry="5" fill="hsl(41 84% 49%)" opacity="0.12" />
        <path
      ...
      <g transform="translate(42, 28)">
        <circle cx="0" cy="0" r="24" fill="hsl(44 88% 90%)" stroke="hsl(41 84% 49%)" strokeWidth="2" />
        <text
          x="0"
          y="8"
          textAnchor="middle"
      ...
      <path
        ...
        opacity="0.2"
      />
      <circle cx="158" cy="118" r="4" fill="hsl(41 84% 49%)" opacity="0.25" />
      <circle cx="172" cy="108" r="3" fill="hsl(41 84% 49%)" opacity="0.18" />
      <circle cx="166" cy="128" r="2.5" fill="hsl(41 84% 49%)" opacity="0.15" />
    </svg>
  )
}
    ...
    <svg viewBox="0 0 200 160" className="h-36 w-44" aria-hidden role="img">
      ...
      <g transform="rotate(-8 100 96)">
        ...
        <path
          ...
          opacity="0.5"
        />
        <ellipse cx="100" cy="72" rx="30" ry="6" fill="hsl(41 84% 49%)" opacity="0.15" />
      </g>
    ...
    <svg viewBox="0 0 200 160" className="h-36 w-44" aria-hidden role="img">
      ...
      <g transform="translate(100, 96)">
        ...
        <path
          ...
          opacity="0.5"
        />
        <ellipse cx="0" cy="-20" rx="28" ry="5" fill="hsl(41 84% 49%)" opacity="0.1" />
        <path
      ...
      <g transform="translate(100, 32)">
        <circle cx="0" cy="0" r="20" fill="hsl(44 88% 90%)" stroke="hsl(41 84% 49%)" strokeWidth="2" />
        <path
