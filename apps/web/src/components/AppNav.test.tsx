...
describe('signed-in primary nav', () => {
  ...
  it('puts logo, destinations, and user menu in the desktop sidebar', () => {
    ...
    expect(nav.querySelector('a[href="/"]')).toHaveTextContent('Tonight')
    expect(nav.querySelector('a[href="/menu"]')).toHaveTextContent('Scan menu')
    expect(nav.querySelector('a[href="/recommendations"]')).toHaveTextContent('Picks')
    expect(nav.querySelector('a[href="/rate"]')).toHaveTextContent('Rate beers')
  ...
  it('shows the same destinations in the mobile bottom bar', () => {
