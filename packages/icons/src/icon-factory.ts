...
const JOURNEY_BODIES: Record<string, string> = {
  ...
  scan: `<rect x="6" y="12" width="24" height="16" rx="3" fill="${L}" stroke="${S}" stroke-width="${W}"/><path d="M11 12l2.5-4h9l2.5 4" fill="${M}" stroke="${S}" stroke-width="${W}" stroke-linejoin="round"/><circle cx="18" cy="20" r="5" fill="${M}" stroke="${S}" stroke-width="1.5"/><circle cx="18" cy="20" r="2.25" fill="${S}"/>`,
}
