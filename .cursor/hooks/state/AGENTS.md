...
- Production stack: Vercel hosts apps/web (`beerolog`, TanStack Start SSR) and apps/api (`beerolog-api`, FastAPI via uv); Neon Postgres is the database; Clerk handles authentication. Domains: beerolog.com / api.beerolog.com (defaults beerolog.vercel.app / beerolog-api.vercel.app).
